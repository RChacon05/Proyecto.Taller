...
def start_sorting(sorted_list, flip_image:bool=False, show_identified_marker:bool=False, show_images:bool=True, show_ids:bool=False, show_coordinates:bool=False)->float:
    ...
    while True:
        ...
        cv2.imshow(f'ARMem', cv2.flip(frame, 1))
...
if __name__=="__main__":
    print(start_sorting([1,3],show_images=True,flip_image=False ,show_coordinates=False, show_ids=False, show_identified_marker=False))
